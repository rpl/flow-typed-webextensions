// WebExtensions Flow types for Firefox 52.0a1 WebExtensions JSON API schema
// generated on Sun Nov 13 2016 21:15:56 GMT+0100 (CET)
// with [flow-typed-webextensions](https://github.com/rpl/flow-typed-webextensions) version 0.1.0
...
declare type webext$manifest$ImageData = {};
...
declare type webext$test$ExpectedError = any;

declare type webext$test$Promise = any;
...
declare function webext$test$assertRejects(promise: webext$test$Promise, expectedError?: webext$test$ExpectedError, message?: string): void;

declare function webext$test$assertThrows(func: Function, expectedError?: webext$test$ExpectedError, message?: string): void;
...
declare type webext$test$test = {|
  ...
  assertRejects: typeof webext$test$assertRejects,
...
declare type webext$sessions$Filter = {|
  maxResults?: number
|};

declare type webext$sessions$Session = {|
  lastModified: number,
  tab?: webext$tabs$Tab,
  window?: webext$windows$Window
|};

declare type webext$sessions$Device = {|
  info: string,
  deviceName: string,
  sessions: Array<webext$sessions$Session>
|};

declare function webext$sessions$getRecentlyClosed(callback?: (sessions: Array<webext$sessions$Session>) => void): Promise<Array<webext$sessions$Session>>;
declare function webext$sessions$getRecentlyClosed(filter: webext$sessions$Filter, callback?: (sessions: Array<webext$sessions$Session>) => void): Promise<Array<webext$sessions$Session>>;

declare function webext$sessions$getDevices(callback?: (devices: Array<webext$sessions$Device>) => void): Promise<Array<webext$sessions$Device>>;
declare function webext$sessions$getDevices(filter: webext$sessions$Filter, callback?: (devices: Array<webext$sessions$Device>) => void): Promise<Array<webext$sessions$Device>>;

declare function webext$sessions$restore(sessionId?: string, callback?: (restoredSession: webext$sessions$Session) => void): Promise<webext$sessions$Session>;

declare type webext$sessions$onChanged = {|
  addListener: (listener: Function) => void,
  removeListener: (listener: Function) => void
|};

declare type webext$sessions$sessions = {|
  onChanged: webext$sessions$onChanged,
  getRecentlyClosed: typeof webext$sessions$getRecentlyClosed,
  getDevices: typeof webext$sessions$getDevices,
  restore: typeof webext$sessions$restore
|};
